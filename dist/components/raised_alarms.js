...
System.register(['app/core/config', 'app/core/app_events', './monasca_client'], function (_export, _context) {
  ...
  var config, appEvents, MonascaClient, _slicedToArray, _createClass, RaisedAlarmsPageCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('RaisedAlarmsPageCtrl', RaisedAlarmsPageCtrl = function () {

        /** @ngInject */
        function RaisedAlarmsPageCtrl($scope, $injector, $location, backendSrv, datasourceSrv, alertSrv) {
          _classCallCheck(this, RaisedAlarmsPageCtrl);
        ...
        _createClass(RaisedAlarmsPageCtrl, [{
          ...
          value: function loadAlarms() {
            ...
            this.monasca.listAlarms(this.filters, 'ALARM').then(function (alarms) {
              _this.alarms = alarms;
            }).catch(function (err) {
...
//# sourceMappingURL=raised_alarms.js.map
